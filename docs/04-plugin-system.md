...
- The dashboard app section renders configured apps as tiles. On macOS, selecting a dashboard app tile opens the same app detail page as the sidebar. User-selectable tile fields are still planned.
